...
useSeoMeta({
  ...
  ogType: 'website',
  ogImage: 'https://cdn.metricshour.com/og/section/countries.png',
  ogImageWidth: '1200',
  ogImageHeight: '630',
  ...
  twitterImage: 'https://cdn.metricshour.com/og/section/countries.png',
...
useHead(computed(() => ({
  ...
  script: [{
    ...
    innerHTML: JSON.stringify({
      ...
      mainEntity: {
        '@type': 'ItemList',
        itemListElement: (countries.value ?? []).slice(0, 50).map((c: any, i: number) => ({
          '@type': 'ListItem',
          position: i + 1,
          name: c.name,
          item: `https://metricshour.com/countries/${c.code.toLowerCase()}/`,
        })),
      },
    }),
  }],
