        ...
        <form @submit.prevent="submit" class="space-y-4">
          ...
          <div>
            <div class="flex items-center justify-between mb-1.5">
              ...
              <NuxtLink to="/auth/forgot-password" class="text-xs text-emerald-500 hover:text-emerald-400 transition-colors">Forgot password?</NuxtLink>
            </div>
            <input
              v-model="password"
              type="password"
...
useSeoMeta({
  title: 'Sign In — MetricsHour',
  description: 'Sign in to MetricsHour and track global markets, trade flows, and economic data.',
  robots: 'noindex',
})
