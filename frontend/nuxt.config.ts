export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    // Live data pages — short cache, data changes daily
    '/earnings/': { headers: { 'Cache-Control': 'public, s-maxage=300, max-age=60, stale-while-revalidate=900' } },
    '/earnings': { headers: { 'Cache-Control': 'public, s-maxage=300, max-age=60, stale-while-revalidate=900' } },
    '/rates/': { headers: { 'Cache-Control': 'public, s-maxage=300, max-age=60, stale-while-revalidate=900' } },
    '/rates': { headers: { 'Cache-Control': 'public, s-maxage=300, max-age=60, stale-while-revalidate=900' } },
    '/yield-curve/': { headers: { 'Cache-Control': 'public, s-maxage=300, max-age=60, stale-while-revalidate=900' } },
    '/yield-curve': { headers: { 'Cache-Control': 'public, s-maxage=300, max-age=60, stale-while-revalidate=900' } },
    '/screener/': { headers: { 'Cache-Control': 'public, s-maxage=300, max-age=60, stale-while-revalidate=900' } },
    '/screener': { headers: { 'Cache-Control': 'public, s-maxage=300, max-age=60, stale-while-revalidate=900' } },
    '/markets/': { headers: { 'Cache-Control': 'public, s-maxage=900, max-age=60, stale-while-revalidate=3600' } },
    '/markets': { headers: { 'Cache-Control': 'public, s-maxage=900, max-age=60, stale-while-revalidate=3600' } },
    ...
    '/stocks/accesscorp': { redirect: { to: '/nigeria/accesscorp/', statusCode: 301 } },
    // FX hyphenated-format redirects (old indexed URLs → canonical 6-char format)
    '/fx/eur-usd/': { redirect: { to: '/fx/eurusd/', statusCode: 301 } },
    '/fx/eur-usd':  { redirect: { to: '/fx/eurusd/', statusCode: 301 } },
    '/fx/gbp-usd/': { redirect: { to: '/fx/gbpusd/', statusCode: 301 } },
    '/fx/gbp-usd':  { redirect: { to: '/fx/gbpusd/', statusCode: 301 } },
    '/fx/usd-jpy/': { redirect: { to: '/fx/usdjpy/', statusCode: 301 } },
    '/fx/usd-jpy':  { redirect: { to: '/fx/usdjpy/', statusCode: 301 } },
    '/fx/usd-cny/': { redirect: { to: '/fx/usdcny/', statusCode: 301 } },
    '/fx/usd-cny':  { redirect: { to: '/fx/usdcny/', statusCode: 301 } },
    '/fx/usd-chf/': { redirect: { to: '/fx/usdchf/', statusCode: 301 } },
    '/fx/usd-chf':  { redirect: { to: '/fx/usdchf/', statusCode: 301 } },
    '/fx/aud-usd/': { redirect: { to: '/fx/audusd/', statusCode: 301 } },
    '/fx/aud-usd':  { redirect: { to: '/fx/audusd/', statusCode: 301 } },
    '/fx/usd-cad/': { redirect: { to: '/fx/usdcad/', statusCode: 301 } },
    '/fx/usd-cad':  { redirect: { to: '/fx/usdcad/', statusCode: 301 } },
    '/fx/usd-mxn/': { redirect: { to: '/fx/usdmxn/', statusCode: 301 } },
    '/fx/usd-mxn':  { redirect: { to: '/fx/usdmxn/', statusCode: 301 } },
    '/fx/usd-brl/': { redirect: { to: '/fx/usdbrl/', statusCode: 301 } },
    '/fx/usd-brl':  { redirect: { to: '/fx/usdbrl/', statusCode: 301 } },
    '/fx/usd-inr/': { redirect: { to: '/fx/usdinr/', statusCode: 301 } },
    '/fx/usd-inr':  { redirect: { to: '/fx/usdinr/', statusCode: 301 } },
    '/fx/nzd-usd/': { redirect: { to: '/fx/nzdusd/', statusCode: 301 } },
    '/fx/nzd-usd':  { redirect: { to: '/fx/nzdusd/', statusCode: 301 } },
