...
def upgrade() -> None:
    ...
    """)
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_assets_market_cap
    ...
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_scr_asset_year
        ON stock_country_revenues(asset_id, fiscal_year DESC)
    """)
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_scr_country_year
